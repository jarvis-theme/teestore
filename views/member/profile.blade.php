<div class="row">
    <div class="col-xs-12 col-sm-12">
        ...
        <p><a href="{{ url('member') }}">Return to Account Details</a></p>
        <br>
        ...
        {{ Form::open(array('url'=>'member/update','method'=>'put')) }}
            <div class="update-address" id="address" style="display: none;">
                <hr>
                <h4>Edit Address</h4>
            ...
            <div class="update-password" id="password" style="display: none;">
                <hr>
                <h4>Edit Password</h4>
